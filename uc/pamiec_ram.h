...
#define MAX_LICZBA_WYSYLANYCH_ZNAKOW_SIM900		400
...
#define tekst_odebranego_smsa		(&wysylany_blok_SIM900[MAX_LICZBA_WYSYLANYCH_ZNAKOW_SIM900-MAX_LICZBA_ZNAKOW_SMS-1])
