...
#define INTERPRETACJA_SMS_DEBUG 8
...
extern uchar
    numer_telefonu_do_ktorego_dzwonic[2 * MAX_LICZBA_ZNAKOW_TELEFON + 1];
extern uchar numer_telefonu_wysylanego_smsa[2 * MAX_LICZBA_ZNAKOW_TELEFON + 1];
