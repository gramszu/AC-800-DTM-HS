...
#define KOPIUJ_SMS_PDU_Z_EEPROM(BUFOR_PTR, EEPROM_PTR)							{ const uchar p = eeprom_read_byte((const uint8_t*) EEPROM_PTR); eeprom_read_block((void*) (BUFOR_PTR), (void*) (EEPROM_PTR), p+1); }
